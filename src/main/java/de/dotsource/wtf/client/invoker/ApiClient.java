package de.dotsource.wtf.client.invoker;
...
import de.dotsource.wtf.client.invoker.auth.Authentication;
import de.dotsource.wtf.client.invoker.auth.HttpBasicAuth;
import de.dotsource.wtf.client.invoker.auth.ApiKeyAuth;
import de.dotsource.wtf.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-10-25T21:44:05.231Z")
@Component("de.dotsource.wtf.client.invoker.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://wtf-o-meter.herokuapp.com";
